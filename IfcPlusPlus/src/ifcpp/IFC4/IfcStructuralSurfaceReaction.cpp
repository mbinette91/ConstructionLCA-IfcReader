...
#include "include/IfcStructuralSurfaceReaction.h"
#include "include/IfcText.h"

// ENTITY IfcStructuralSurfaceReaction 
IfcStructuralSurfaceReaction::IfcStructuralSurfaceReaction() { m_entity_enum = IFCSTRUCTURALSURFACEREACTION; }
IfcStructuralSurfaceReaction::IfcStructuralSurfaceReaction( int id ) { m_id = id; m_entity_enum = IFCSTRUCTURALSURFACEREACTION; }
IfcStructuralSurfaceReaction::~IfcStructuralSurfaceReaction() {}
shared_ptr<IfcPPObject> IfcStructuralSurfaceReaction::getDeepCopy( IfcPPCopyOptions& options )
{
...
void IfcStructuralSurfaceReaction::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_id << "= IFCSTRUCTURALSURFACEREACTION" << "(";
...
void IfcStructuralSurfaceReaction::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_id; }
void IfcStructuralSurfaceReaction::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	const int num_args = (int)args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcStructuralSurfaceReaction, expecting 10, having " << num_args << ". Entity ID: " << m_id << std::endl; throw IfcPPException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcStructuralSurfaceActivityTypeEnum::createObjectFromSTEP( args[9] );
}
void IfcStructuralSurfaceReaction::getAttributes( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes )
{
...
void IfcStructuralSurfaceReaction::unlinkFromInverseCounterparts()
{
