...
#include "include/IfcSpatialZone.h"
#include "include/IfcSpatialZoneTypeEnum.h"
#include "include/IfcText.h"

// ENTITY IfcSpatialZone 
IfcSpatialZone::IfcSpatialZone() { m_entity_enum = IFCSPATIALZONE; }
IfcSpatialZone::IfcSpatialZone( int id ) { m_id = id; m_entity_enum = IFCSPATIALZONE; }
...
void IfcSpatialZone::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_PredefinedType = IfcSpatialZoneTypeEnum::createObjectFromSTEP( args[8] );
}
void IfcSpatialZone::getAttributes( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes )
{
	IfcSpatialElement::getAttributes( vec_attributes );
	vec_attributes.push_back( std::make_pair( "PredefinedType", m_PredefinedType ) );
}
void IfcSpatialZone::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes_inverse )
{
	IfcSpatialElement::getAttributesInverse( vec_attributes_inverse );
}
void IfcSpatialZone::setInverseCounterparts( shared_ptr<IfcPPEntity> ptr_self_entity )
{
	IfcSpatialElement::setInverseCounterparts( ptr_self_entity );
}
void IfcSpatialZone::unlinkFromInverseCounterparts()
{
