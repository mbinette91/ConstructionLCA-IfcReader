...
#include "include/IfcProtectiveDeviceType.h"
...
IfcProtectiveDeviceType::IfcProtectiveDeviceType() { m_entity_enum = IFCPROTECTIVEDEVICETYPE; }
IfcProtectiveDeviceType::IfcProtectiveDeviceType( int id ) { m_id = id; m_entity_enum = IFCPROTECTIVEDEVICETYPE; }
IfcProtectiveDeviceType::~IfcProtectiveDeviceType() {}
shared_ptr<IfcPPObject> IfcProtectiveDeviceType::getDeepCopy( IfcPPCopyOptions& options )
{
...
void IfcProtectiveDeviceType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_id << "= IFCPROTECTIVEDEVICETYPE" << "(";
...
void IfcProtectiveDeviceType::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	const int num_args = (int)args.size();
	if( num_args != 10 ){ std::stringstream err; err << "Wrong parameter count for entity IfcProtectiveDeviceType, expecting 10, having " << num_args << ". Entity ID: " << m_id << std::endl; throw IfcPPException( err.str().c_str() ); }
	...
	m_PredefinedType = IfcProtectiveDeviceTypeEnum::createObjectFromSTEP( args[9] );
}
void IfcProtectiveDeviceType::getAttributes( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes )
{
...
void IfcProtectiveDeviceType::unlinkFromInverseCounterparts()
{
