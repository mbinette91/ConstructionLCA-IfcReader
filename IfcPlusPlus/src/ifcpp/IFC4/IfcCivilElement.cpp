...
#include "include/IfcCivilElement.h"
...
IfcCivilElement::IfcCivilElement() { m_entity_enum = IFCCIVILELEMENT; }
IfcCivilElement::IfcCivilElement( int id ) { m_id = id; m_entity_enum = IFCCIVILELEMENT; }
IfcCivilElement::~IfcCivilElement() {}
shared_ptr<IfcPPObject> IfcCivilElement::getDeepCopy( IfcPPCopyOptions& options )
{
...
void IfcCivilElement::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_id << "= IFCCIVILELEMENT" << "(";
...
void IfcCivilElement::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
...
void IfcCivilElement::getAttributes( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes )
{
	IfcElement::getAttributes( vec_attributes );
}
void IfcCivilElement::getAttributesInverse( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes_inverse )
{
	IfcElement::getAttributesInverse( vec_attributes_inverse );
}
void IfcCivilElement::setInverseCounterparts( shared_ptr<IfcPPEntity> ptr_self_entity )
{
	IfcElement::setInverseCounterparts( ptr_self_entity );
}
void IfcCivilElement::unlinkFromInverseCounterparts()
{
