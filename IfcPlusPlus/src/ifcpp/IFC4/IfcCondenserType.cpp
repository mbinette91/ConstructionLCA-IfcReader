...
#include "include/IfcCondenserType.h"
...
IfcCondenserType::IfcCondenserType() { m_entity_enum = IFCCONDENSERTYPE; }
IfcCondenserType::IfcCondenserType( int id ) { m_id = id; m_entity_enum = IFCCONDENSERTYPE; }
...
void IfcCondenserType::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_PredefinedType = IfcCondenserTypeEnum::createObjectFromSTEP( args[9] );
}
...
void IfcCondenserType::unlinkFromInverseCounterparts()
{
