...
#include "include/IfcFlowTerminalType.h"
...
IfcFlowTerminalType::IfcFlowTerminalType() { m_entity_enum = IFCFLOWTERMINALTYPE; }
IfcFlowTerminalType::IfcFlowTerminalType( int id ) { m_id = id; m_entity_enum = IFCFLOWTERMINALTYPE; }
IfcFlowTerminalType::~IfcFlowTerminalType() {}
shared_ptr<IfcPPObject> IfcFlowTerminalType::getDeepCopy( IfcPPCopyOptions& options )
{
	shared_ptr<IfcFlowTerminalType> copy_self( new IfcFlowTerminalType() );
	if( m_GlobalId )
	{
...
void IfcFlowTerminalType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_id << "= IFCFLOWTERMINALTYPE" << "(";
...
void IfcFlowTerminalType::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
...
void IfcFlowTerminalType::getAttributes( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes )
{
...
void IfcFlowTerminalType::unlinkFromInverseCounterparts()
{
