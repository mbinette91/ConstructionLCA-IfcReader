...
#include "include/IfcFlowStorageDeviceType.h"
...
IfcFlowStorageDeviceType::IfcFlowStorageDeviceType() { m_entity_enum = IFCFLOWSTORAGEDEVICETYPE; }
IfcFlowStorageDeviceType::IfcFlowStorageDeviceType( int id ) { m_id = id; m_entity_enum = IFCFLOWSTORAGEDEVICETYPE; }
IfcFlowStorageDeviceType::~IfcFlowStorageDeviceType() {}
shared_ptr<IfcPPObject> IfcFlowStorageDeviceType::getDeepCopy( IfcPPCopyOptions& options )
{
...
void IfcFlowStorageDeviceType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_id << "= IFCFLOWSTORAGEDEVICETYPE" << "(";
...
void IfcFlowStorageDeviceType::getStepParameter( std::stringstream& stream, bool ) const { stream << "#" << m_id; }
void IfcFlowStorageDeviceType::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	const int num_args = (int)args.size();
	if( num_args != 9 ){ std::stringstream err; err << "Wrong parameter count for entity IfcFlowStorageDeviceType, expecting 9, having " << num_args << ". Entity ID: " << m_id << std::endl; throw IfcPPException( err.str().c_str() ); }
...
void IfcFlowStorageDeviceType::getAttributes( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes )
{
...
void IfcFlowStorageDeviceType::unlinkFromInverseCounterparts()
{
