...
void IfcWindow::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
...
void IfcWindow::unlinkFromInverseCounterparts()
{
