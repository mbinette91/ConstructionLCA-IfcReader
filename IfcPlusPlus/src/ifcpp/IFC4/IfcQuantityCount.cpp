...
void IfcQuantityCount::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_CountValue = IfcCountMeasure::createObjectFromSTEP( args[3] );
