...
void IfcFeatureElementSubtraction::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_id << "= IFCFEATUREELEMENTSUBTRACTION" << "(";
...
void IfcFeatureElementSubtraction::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
