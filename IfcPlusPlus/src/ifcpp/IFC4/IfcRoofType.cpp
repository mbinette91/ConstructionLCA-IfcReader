...
#include "include/IfcRoofType.h"
#include "include/IfcRoofTypeEnum.h"
#include "include/IfcText.h"

// ENTITY IfcRoofType 
IfcRoofType::IfcRoofType() { m_entity_enum = IFCROOFTYPE; }
IfcRoofType::IfcRoofType( int id ) { m_id = id; m_entity_enum = IFCROOFTYPE; }
IfcRoofType::~IfcRoofType() {}
shared_ptr<IfcPPObject> IfcRoofType::getDeepCopy( IfcPPCopyOptions& options )
{
...
void IfcRoofType::getStepLine( std::stringstream& stream ) const
{
	stream << "#" << m_id << "= IFCROOFTYPE" << "(";
...
void IfcRoofType::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_PredefinedType = IfcRoofTypeEnum::createObjectFromSTEP( args[9] );
}
void IfcRoofType::getAttributes( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes )
{
...
void IfcRoofType::unlinkFromInverseCounterparts()
{
