...
#include "include/IfcProcedureType.h"
...
void IfcProcedureType::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_PredefinedType = IfcProcedureTypeEnum::createObjectFromSTEP( args[9] );
}
