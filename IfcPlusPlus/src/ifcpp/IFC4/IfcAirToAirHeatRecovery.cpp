...
#include "include/IfcAirToAirHeatRecovery.h"
...
IfcAirToAirHeatRecovery::IfcAirToAirHeatRecovery() { m_entity_enum = IFCAIRTOAIRHEATRECOVERY; }
IfcAirToAirHeatRecovery::IfcAirToAirHeatRecovery( int id ) { m_id = id; m_entity_enum = IFCAIRTOAIRHEATRECOVERY; }
...
void IfcAirToAirHeatRecovery::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_PredefinedType = IfcAirToAirHeatRecoveryTypeEnum::createObjectFromSTEP( args[8] );
}
