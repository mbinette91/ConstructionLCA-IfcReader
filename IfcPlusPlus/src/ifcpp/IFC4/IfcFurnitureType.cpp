...
shared_ptr<IfcPPObject> IfcFurnitureType::getDeepCopy( IfcPPCopyOptions& options )
{
...
void IfcFurnitureType::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_AssemblyPlace = IfcAssemblyPlaceEnum::createObjectFromSTEP( args[9] );
	m_PredefinedType = IfcFurnitureTypeEnum::createObjectFromSTEP( args[10] );
}
void IfcFurnitureType::getAttributes( std::vector<std::pair<std::string, shared_ptr<IfcPPObject> > >& vec_attributes )
{
...
void IfcFurnitureType::unlinkFromInverseCounterparts()
{
