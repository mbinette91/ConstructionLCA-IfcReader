...
void IfcClassificationReference::readStepArguments( const std::vector<std::wstring>& args, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	...
	m_Sort = IfcIdentifier::createObjectFromSTEP( args[5] );
}
