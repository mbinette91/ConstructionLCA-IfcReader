...
shared_ptr<IfcPointOrVertexPoint> IfcPointOrVertexPoint::createObjectFromSTEP( const std::wstring& arg, const boost::unordered_map<int,shared_ptr<IfcPPEntity> >& map )
{
	// read TYPE
